...
struct parameters {
    ...
    /* Scoring mode for TREEWISE:
       0 (Default) - Don't weight scores
       1 - Weight scores using the pairwise Sc score between the sequences being compared.
       2 - Some other really clever scoring method...
    */
    int TREESCORE;
    int DSSP;			
    int PAIROUTPUT;			
